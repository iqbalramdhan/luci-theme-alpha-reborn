# LuCI Alpha 4.1 (beta) Theme
# Copyright 2025 derisamedia <yuimizuno86@gmail.com>
#
...
define Package/luci-theme-$(THEME_NAME)
  ...
  SUBMENU:=9. Themes
  DEPENDS:=+libc
  TITLE:=LuCi Theme For OpenWrt And Alpha OS ONLY (For OpenWrt. 24.xx) - $(THEME_TITLE)
